...
<form action = "pag.php" method="GET">
  ...
  <p><input style = "width:150;heigth:150;padding:10px;font:18px Arial" type="submit" value="Cambiar Color"></p>

</form>
<form action = "nota.php" method="GET">
  <p><input style = "width:150;heigth:150;padding:10px;font:18px Arial" type="submit" value="Ver Notas"></p>
</form>
