...
<?php
	...
	$sql = "SELECT DISTINCT sigla FROM nota order by sigla";
...
<br/>
<h3><input style = "width:150;heigth:150;padding:10px;font:18px Arial" type="submit" name="consulta" value="Consulta SQL"/></h3>
</form>
</center>
</div>
